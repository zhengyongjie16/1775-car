const pca = {
  ...
  120000: {
    120101: '和平区', 120102: '河东区', 120103: '河西区', 120104: '南开区', 120105: '河北区', 120106: '红桥区', 120110: '东丽区', 120111: '西青区', 120112: '津南区', 120113: '北辰区', 120114: '武清区', 120115: '宝坻区', 120116: '滨海新区', 120117: '宁河区', 120118: '静海区', 120119: '蓟州区',
  },
  130000: {
    130100: '石家庄市', 130200: '唐山市', 130300: '秦皇岛市', 130400: '邯郸市', 130500: '邢台市', 130600: '保定市', 130700: '张家口市', 130800: '承德市', 130900: '沧州市', 131000: '廊坊市', 131100: '衡水市', 139001: '定州市', 139002: '辛集市',
  },
  140000: {
  ...
  310000: {
    310101: '黄浦区', 310104: '徐汇区', 310105: '长宁区', 310106: '静安区', 310107: '普陀区', 310109: '虹口区', 310110: '杨浦区', 310112: '闵行区', 310113: '宝山区', 310114: '嘉定区', 310115: '浦东新区', 310116: '金山区', 310117: '松江区', 310118: '青浦区', 310120: '奉贤区', 310151: '崇明区',
  },
  320000: {
  ...
  540000: {
    540100: '拉萨市', 540200: '日喀则市', 540300: '昌都市', 540400: '林芝市', 540500: '山南市', 542400: '那曲地区', 542500: '阿里地区',
  },
  610000: {
  ...
  650000: {
    650100: '乌鲁木齐市', 650200: '克拉玛依市', 650400: '吐鲁番市', 650500: '哈密市', 652300: '昌吉回族自治州', 652700: '博尔塔拉蒙古自治州', 652800: '巴音郭楞蒙古自治州', 652900: '阿克苏地区', 653000: '克孜勒苏柯尔克孜自治州', 653100: '喀什地区', 653200: '和田地区', 654000: '伊犁哈萨克自治州', 654200: '塔城地区', 654300: '阿勒泰地区', 659001: '石河子市', 659002: '阿拉尔市', 659003: '图木舒克市', 659004: '五家渠市', 659006: '铁门关市',
  },
  710000: {
    710101: '金门', 710102: '连江', 710103: '苗栗', 710104: '南投', 710105: '澎湖', 710106: '屏东', 710107: '台东', 710108: '台中', 710109: '台南', 710110: '台北', 710111: '桃园', 710112: '云林', 710113: '新北', 710114: '彰化', 710115: '嘉义', 710116: '新竹', 710117: '花莲', 710118: '宜兰', 710119: '高雄', 710120: '基隆',
  },
  810000: {
    810101: '中西区', 810102: '东区', 810103: '九龙城区', 810104: '观塘区', 810105: '深水埗区', 810106: '湾仔区', 810107: '黄大仙区', 810108: '油尖旺区', 810109: '离岛区', 810110: '葵青区', 810111: '北区', 810112: '西贡区', 810113: '沙田区', 810114: '屯门区', 810115: '大埔区', 810116: '荃湾区', 810117: '元朗区', 810118: '香港', 810119: '九龙', 810120: '新界',
  },
  820000: {
    820101: '离岛', 820102: '澳门半岛', 820103: '凼仔', 820104: '路凼城', 820105: '路环',
  },
};
...
for (const item of options) {
  ...
  item.children.options = _options;
}

cityData.options = options;
