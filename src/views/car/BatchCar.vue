  ...
  <div class="main">
    ...
    <div class="search">
      <div class="input">
        ...
        <input :class="{op:searchTxt.length>0,focus:isfocus}" @blur="isfocus=false" @focus="isfocus=true" type="text" v-model="searchTxt">
      </div>
    ...
    <div class="content">
      ...
      >
        ...
        <!--车辆列表-->
        <pfCard class="carItem"  v-for="(car,index) in carList" :key="`${car.id}_${index}`" :carData="car"></pfCard>
        <!--加载更多-->
        <md-scroll-view-more
          slot="more"
          :is-finished="isEnd"
