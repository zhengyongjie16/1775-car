<template>
  <div class="main">
    <navTag :isShare="false" title="分享车辆"></navTag>
    <div class="search">
      <div class="state" @click="isUpper=!isUpper">
        {{upperTxt}}
        <div class="choItem" v-show="isUpper==true">
          <div class="tag" @click.stop="changeState('上架')">上架</div>
          <div class="tag" @click.stop="changeState('下架')">下架</div>
        </div>
      </div>
      <div class="input">
        ...
        <input :class="{op:searchTxt.length>0,op1:fause==true}" @focus="fause=true" @blur="fause=false" type="text" v-model="searchTxt">
      </div>
