<template>
  <div class="main">
    <div class="nav">
      ...
      <div class="del" @click="delGoods">删除商品</div>
    </div>
    <div class="content">
<!--      <md-scroll-view-->
<!--        :scrolling-x="false"-->
...
<!--      </md-scroll-view>-->
    ...
    <div class="fixbtn" @click="updateGoods">确定修改</div>
  ...
  export default {
    ...
    methods: {
      ...
      async getGoodsDetail(){
         const res = await this.$api.post('/findGoodsDetail',{id: this.$route.query.id})
         const { data, success, info } = res.data
         if(!success) return this.$toast.info(info,1000)
         this.formData = data
         this.cover = data.cover
         this.imageList = data.swiper.split(',')
      },
      ...
      async updateGoods(){
       const formData = this.formData
        ...
        formData.swiper = this.imageList.toString()
        ...
        const res = await this.$api.post('/updateGoods',formData)
        const { data, success, info } = res.data
        if(!success) return this.$toast.info(info,1000)
      ...
      async delGoods(){
        this.$dialog.confirm({
          ...
          onConfirm: async () =>{
            ...
            const res = await this.$api.post('/delGoods',{id})
            const { info } = res.data
            this.$toast.info(info,1000)
            this.$router.go(-1)
          }
